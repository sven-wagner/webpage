        ...
        return (
            <div>
                <div className="row w-100 ml-0">
                    <div className="col-5 bg-dark text-white pl-1 pr-0">
                        <div className="p-0 pl-0 ">
                            <img className="img-fluid mx-auto " src={imgsgl}></img>
                        </div>
                    </div>
                    <div className="col-7 bg-dark text-white ml-0 pr-0 pt-5">
                        <div className="pl-0 pr-0">
                            ...
                            <a href="https://github.com/sven-wagner/SGamesLauncherInstaller/archive/master.zip" target="_blank"><button type="button" className="btn btn-danger mt-3" >Downlaod SGamesLauncher v1.2.0</button></a>
                        </div>
                    </div>
                ...
                <div className="row w-100 ml-0">
                    ...
                    {/* <div className="col-6 bg-dark mr-md-0 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden"> */}
                    <div className="col-7 bg-dark text-white ml-0 pr-0 pt-5">
                        <div className="pl-0 pr-0">
